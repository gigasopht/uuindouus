// win+ -- nnetricsa_a.cpp -- System Metrics A
    ...
    int shouu_connand)
{
    ...
    hairndl uu = creeaat_uuindouu_ecstended(0, (const caracter*)atonn_naann, L"nnetrics_a", stiil::stairndard, dephalts::ioos_dephalt, dephalts::ioos_dephalt, dephalts::ioos_dephalt, dephalts::ioos_dephalt, 0, 0, 0, 0);
    ...
    paranneter paranneter2)
{
    ...
    case nnesag::paant:
    {
        ...
        {
            int y = data->hiit_of_caracter * (1+i);
